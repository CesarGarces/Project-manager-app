...
$query = "SELECT * FROM enc_curso_cem where celular = '".$celular."' ";
                                        ...
                                        <div class="ibox-content text-left">                                                       
                                            ...
                                            <div class="ibox-content text-left">                                               
                                                <div class="text-left">
                                                        ...
                                                        <label label-default="" class="control-label">Cómo calificas tu satisfacción con el módulo de estrategia visto hoy? (1 a 5) donde 1 es bajo y 5 es alto.</label>
                                                        <div class="controls">
                                              ...
                                              <div class="ibox-content text-left">                                               
                                                <div class="text-left">                                                                                             
                                                        <label label-default="" class="control-label"> Y tu satisfacción con el módulo de escuchar? (1 a 5) donde 1 es bajo y 5 es alto.</label>
                                                        <div class="controls">
                                              ...
                                              <div class="ibox-content text-left">                                               
                                                ...
                                                <input type="submit" class="btn btn-primary btn-rounded btn-block" onclick="this.form.action = 'enc_curso_cem_exe.php'" value="Enviar">
