               ...
               <span>
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="Indicador_list.php">Indicadores</a></li>
        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
                ...
                <div class="ibox">
                    ...
                    <table class="table table-striped table-hover" data-page-size="15" style="font-size: small;">
                        ...
                        <tbody>
                            <form indicador="form" action="new_indicador_exe.php" method="post" >
							<tr>
								<td>
								<input type="text" class="form-control"  title="t_indicador" required  name="t_indicador" value="">
								</td>
								<td>
								<input type="text" class="form-control"  title="escala" required  name="escala" value="">
								</td>
								<td>
								<input type="text" class="form-control"  title="calculo" required  name="calculo" value="">
								</td>
								<td>  
								<a class="btn btn-white" href="canal_list.php">Cancel</a>&nbsp;
