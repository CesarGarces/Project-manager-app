...
$sql_actividades = mysql_query("SELECT c.id_sys_actividades, d.nombre tipo_actividad, c.nombre actividad FROM sys_actividades c, sys_tipo_actividades d WHERE c.id_tipo_actividad = d.id_tipo_actividad");
?>
<table class="table table-bordered" width="100%">
	...
	<tr>
        ...
        <td style="vertical-align:middle;"><?php echo $fetch_actividades['tipo_actividad']; ?></td>
		<td style="vertical-align:middle;"><?php echo $fetch_actividades['actividad']; ?></td>
        <td align="center"><a onclick="editActividad(<?php echo $fetch_actividades["id_sys_actividades"]; ?>);" data-toggle="modal" data-target="#modal-form" rel="tooltip" title data-placement="top" data-original-title="Modificar Actividad" style="text-decoration:none;color:white;" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a></td>
        <td align="center"><a onclick="deleteActividad(<?php echo $fetch_actividades["id_sys_actividades"]; ?>);" data-toggle="modal" data-target="#modal-form" rel="tooltip" title data-placement="top" data-original-title="Eliminar Actividad" style="text-decoration:none;color:white;" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a><br></td>
    </tr>
    <?php
	}
	?>
