...
$fecha=date('Y-m-d');
	...
	if(isset($_REQUEST['del']) && $_REQUEST['del'] != 0)
	{
		...
		$sql_dependencia = mysql_query("SELECT * FROM sys_proyectos WHERE id_proyecto =  ".$_REQUEST['del']);
	...
	$sql_dependencias = mysql_query("SELECT * FROM sys_proyectos");
	
?>
<h3>Eliminar Proyecto </h3>
<p></p>
<br>
<h4>Estas seguro que deseas eliminar el Proyecto <?php echo $fetch_dependencias[3]; ?> ? <h4>
<h5>Esta acción no podrá reversarse en el futuro.</h5>
<br>
<br>
<div align="center">
<a href="configuraciones_maestras2.php?action=del&form=proyecto&proyecto=<?php echo $dependencia; ?>&msj=Proyecto <?php echo $fetch_dependencias[3]; ?> Eliminado Satisfactoriamente" type="button" class="btn btn-w-m btn-danger"><i class="fa fa-trash"></i> Eliminar</a> <button type="button" class="btn btn-w-m btn-default" data-dismiss="modal"> Cerrar</button>
</div>