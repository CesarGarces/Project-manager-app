...
$fecha=date('Y-m-d');
	...
	if(isset($_REQUEST['del']) && $_REQUEST['del'] != 0)
	{
		...
		$sql_dependencia = mysql_query("SELECT * FROM sys_tipo_proyectos WHERE id_tipo_proyecto =  ".$_REQUEST['del']);
