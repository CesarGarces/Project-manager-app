...
$sql_dependencia = mysql_query("SELECT * FROM sys_dependencias");
?>
<table class="table table-bordered" width="100%">
    ...
    <?php
    $contador = 0;
	while($fetch_dependencia = mysql_fetch_array($sql_dependencia))
	{	
    $contador ++;	
	?>
	<tr>
        <td style="vertical-align:middle;"><?php echo $contador; ?></td>
        <td style="vertical-align:middle;"><?php echo $fetch_dependencia['nombre']; ?></td>
        <td align="center"><a onclick="editDependencia(<?php echo $fetch_dependencia["id_dependencia"]; ?>);" data-toggle="modal" data-target="#modal-form" rel="tooltip" title data-placement="top" data-original-title="Modificar Dependencia" style="text-decoration:none;color:white;" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a></td>
        <td align="center"><a onclick="deleteDependencia(<?php echo $fetch_dependencia["id_dependencia"]; ?>);" data-toggle="modal" data-target="#modal-form" rel="tooltip" title data-placement="top" data-original-title="Eliminar Dependencia" style="text-decoration:none;color:white;" class="btn btn-danger btn-circle btn-sm"><i class="fa fa-trash"></i></a><br></td>
    </tr>
    <?php
	}
	?>
