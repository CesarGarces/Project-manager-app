      ...
      <div class="row border-bottom">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-10">
                    ...
                    <h2>Nuevo Permiso de Operación</h2>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            ...
                            <strong>Nuevo Permiso de Operación</strong>
                                ...
                                <div class="ibox">
                                    ...
                                    <div class="ibox-content">                    
                                        ...
                                        <div class="row">
                                            ...
                                            <form role="form" action="new_permiso_exe.php" method="post" >
                                                ...
                                                <input type="hidden"  name="usuario_crea" value="<?php echo $_SESSION['user']; ?>">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-heading"><h3 class="panel-title">Descripcion de Permisos</h3>
