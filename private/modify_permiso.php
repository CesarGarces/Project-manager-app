...
$single_permiso = $objLin->single_permiso($id_permiso);
...
<head>
    ...
    <title>IZO | Modificar Permiso</title>
      ...
      <div class="row border-bottom">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-10">
                    ...
                    <h2>Modificar Permisos de Operación</h2>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="permisos_list.php">Permisos</a>
...
<form role="form" action="modify_permiso_exe.php" method="post" >

    <input type="hidden"  name="usuario_modifica" value="<?php echo $_SESSION['user']; ?>">

    <?php

    $numrows = mysql_num_rows($single_permiso);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($single_permiso)){?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-block m-b-none">Nombre que describe el permiso de operación.</span>

                            </div>

                          </div>

                          <a class="btn btn-white" href="permisos_list.php">Cancel</a>&nbsp;
