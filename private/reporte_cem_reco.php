...
$list_reporte_inicial = mysql_query("SELECT * FROM enc_curso_cem_reco");
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a><i class="fa fa-slideshare"></i> Curso CEM<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level collapse">
                                ...
                                <li class="active"><a href="reporte_cem_reco.php">Respuestas Recomendación</a></li>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        ...
                        <th>Celular</th>
                        <th>¿Recomendarías a un familiar, amigo, o colega asistir al "PROGRAMA DE FORMACIÓN DE LA EXPERIENCIA DEL CLIENTE" By IZO? Califica de 0 al 10</th>
                        <th>¿Tienes algo que quieras recomendar para mejorar nuestro programa de formación?</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
