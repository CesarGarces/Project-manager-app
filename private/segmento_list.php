        ...
        <div class="row border-bottom">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-10">
                    ...
                    <h2>Administración de Segmentos</h2>
        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-title">
                            ...
                            <h5>Listado de Segmentos</h5>

                            <div class="ibox-tools">

                                <a href="new_segmento.php" class="btn btn-primary btn-xs">Nuevo Segmento</a>
                        ...
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo $row["id_segmento"];?>

                                        </td>

                                        <td>

                                            <?php echo $row["segmento"];?>
