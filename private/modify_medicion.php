...
$single_medicion = $objLin->single_medicion($id_medicion);
...
<head>
    ...
    <title>IZO | Modificar Medicion</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="lineas_list.php">Lineas</a></li>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            ...
                            <strong>Modificar Medicion</strong>
...
<form role="form" action="modify_medicion_exe.php" method="post" >

    <input type="hidden"  name="usuario_modifica" value="<?php echo $_SESSION['user']; ?>">

    <?php

    $numrows = mysql_num_rows($single_medicion);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($single_medicion)){?>

                    <input type="hidden" name="id_medicion" value="<?php echo $id_medicion;?>">
    ...
    <div class="col-md-12">
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <label label-default="" class="control-label">Nombre</label>
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        ...
                                                                                        <input type="text" class="form-control"  title="Rol" required  name="nombre" value="<?php echo $row["nombre"];?>">
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <label label-default="" class="control-label">Tipo Medición</label>
                                                                                    ...
                                                                                    <select class="form-control required m-b valid" name="TipoMedicion" required >
                                                                                        ...
                                                                                        <option selected value="<?php echo $row["tipo_encuesta"];?>"><?php echo $row["tipo_encuesta"];?></option>
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <label label-default="" class="control-label">Mensaje</label>
                                                                                    ...
                                                                                    <textarea class="form-control required" cols="20" id="Mensaje" name="Mensaje" rows="2" aria-required="true"><?php echo $row["mensaje"];?></textarea>
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <label label-default="" class="control-label">Link</label>

                                                                                    <div class="controls">

                                                                                        <input type="text" class="form-control" name="link" value="<?php echo $row["link"];?>">

                                                                                            <span class="help-block m-b-none">Link si aplica.</span>
