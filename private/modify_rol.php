...
$users_rol_id = $objUse->users_rol_id($idrol);
...
<form role="form" action="modify_rol_exe.php" method="post" >

    <input type="hidden"  name="usuario_modifica" value="<?php echo $_SESSION['user']; ?>">

    <?php

    $numrows = mysql_num_rows($users_rol_id);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($users_rol_id)){?>

                    <input type="hidden" name="id_rol" value="<?php echo $idrol;?>">
    ...
    <div class="panel panel-default">
            ...
            <div class="panel-heading"><h3 class="panel-title">Descripcion del rol</h3></div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="form-control"  title="Rol" required  name="Rol" value="<?php echo $row["rol"];?>">
