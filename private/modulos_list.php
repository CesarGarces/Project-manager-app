        ...
        <div class="row border-bottom">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-10">
                    ...
                    <h2>Administración de Modulos</h2>
            ...
            <div class="ibox">
                ...
                <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                ...
                                <a href="new_modulo.php" class="btn btn-primary btn-xs">Nuevo Modulo</a>
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($list_modulo)){
                        ...
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions">
                                                ...
                                                <a href="modify_modulo.php?id_modulo=<?php echo $id_modulo;?>" class="btn btn-xs btn-warning glyphicon glyphicon-pencil" title="Editar"></a>

                                                <a href="#" id="<?php echo $id_modulo;?>" class="btn btn-xs btn-danger glyphicon glyphicon-trash btn-sm demo4" title="Eliminar"></a>  
                    ...
                    function (isConfirm) {
                        ...
                        if (isConfirm) {
                            ...
                            setTimeout(function() {
                                 ...
                                 window.location = 'delete_modulo.php?id_modulo='+numero;
