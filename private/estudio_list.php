...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                ...
                                <a href="new_estudio.php" class="btn btn-primary btn-xs">Nuevo Estudio</a>
                ...
                $numrows = mysql_num_rows($list_estudio);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($list_estudio)){
