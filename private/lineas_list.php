        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
            ...
            <div class="ibox">
                ...
                <div class="ibox-title">
                            ...
                            <h5>Listado de Lineas</h5>

                            <div class="ibox-tools">

                                <a href="new_linea.php" class="btn btn-primary btn-xs">Nueva Linea</a>
                ...
                $numrows = mysql_num_rows($list_linea);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($list_linea)){

                        $id_linea = $row["id_linea"];

                        $nom_linea = $row["nombre"];
                        ...
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo $row["id_usuario_crea"];?>

                                        </td>

                                        <td>

                                            <?php echo $row["id_usuario_modifica"];?>
                                        ...
                                        <td>
                                            ...
                                            <?php echo $row["fecha_modifica"];?>

                                        </td>

                                        <td class="project-actions">

                                                <a href="modify_linea.php?id_linea=<?php echo $id_linea;?>" class="btn btn-xs btn-warning glyphicon glyphicon-pencil" title="Editar"></a>

                                                <a href="#" id="<?php echo $id_linea;?>" class="btn btn-xs btn-danger glyphicon glyphicon-trash btn-sm demo4" title="Eliminar"></a>  
                    ...
                    function (isConfirm) {
                        ...
                        if (isConfirm) {
                            ...
                            setTimeout(function() {
                                 ...
                                 window.location = 'delete_linea.php?id_linea='+numero;
