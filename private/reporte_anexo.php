        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        ...
                        <th>macro3</th>
                        <th>anexo_fcr</th>
						<th>anexo_fcr_chek1</th>
						<th>anexo_fcr_chek2</th>
						<th>anexo_fcr_chek3</th>
						<th>anexo_fcr_chek4</th>
						<th>anexo_enc5</th>
						<th>anexo_enc6</th>
						<th>anexo_enc7</th>
						<th>anexo_enc8</th>
						<th>TMO</th>
						<th>TME</th>
						<th>Comentarios Relevantes del cliente (VOC)</th>
						...
						<tr>
							...
							<td>
								<?php echo $pec_uf['macro'] ?>
							</td>
							<td>
								<?php echo $pec_uf['macro2'] ?>
							</td>
							<td>
								<?php echo $pec_uf['macro3'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_fcr'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_fcr_chek1'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_fcr_chek2'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_fcr_chek3'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_fcr_chek4'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_enc5'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_enc6'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_enc7'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_enc8'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_enc9'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_enc10'] ?>
							</td>							
							<td>
								<?php echo $pec_uf['anexo_enc11'] ?>
							</td>
							<td>
								<?php echo $pec_uf['anexo_enc12'] ?>
							</td>
