...
<head>
    ...
    <title>IZO | Nuevo segmento</title>
               ...
               <span>
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="segmento_list.php">Segmentos</a></li>
						...
						<div class="ibox">
							...
							<div class="ibox-content">                    
								...
								<div class="row">
									...
									<form segmento="form" action="new_segmento_exe.php" method="post" >
										...
										<input type="hidden"  name="usuario_crea" value="<?php echo $_SESSION['user']; ?>">
											...
											<div class="col-sm-12">
												...
												<div class="panel panel-default">
													...
													<div class="panel-heading"><h3 class="panel-title">Nuevo Segmento</h3>
															...
															<div class="row">
																...
																<div class="col-md-12">
																	...
																	<div class="control-group">
																		...
																		<label label-default="" class="control-label">Nombre Segmento</label>

																			<div class="controls">

																				<input type="text" class="form-control"  title="segmento" required  name="segmento" value="">

																			</div>
																			
																	</div>

																		<a class="btn btn-white" href="segmento_list.php">Cancel</a>&nbsp;
