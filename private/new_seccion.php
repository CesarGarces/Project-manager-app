...
$list_modulo = $objLin->list_modulo();
                                ...
                                <div class="ibox">
                                    ...
                                    <div class="ibox-content">                    
                                        ...
                                        <div class="row">
                                            ...
                                            <form role="form" action="new_seccion_exe.php" method="post" >
                                                ...
                                                <input type="hidden"  name="usuario_crea" value="<?php echo $_SESSION['user']; ?>">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-heading"><h3 class="panel-title">Descripcion de la Seccion</h3>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <label label-default="" class="control-label">Codigo Sección</label>

                                                                                    <div class="controls">

                                                                                        <input type="text" class="form-control" required  name="codigo_seccion" value="">

                                                                                            <span class="help-block m-b-none">Codigo Unico de la Seccion.</span>
                                                                                ...
                                                                                <label label-default="" class="control-label">Nombre</label>
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        ...
                                                                                        <input type="text" class="form-control"  title="Rol" required  name="nombre" value="">
                                                                                            ...
                                                                                            <span class="help-block m-b-none">Nombre que describe la Seccion.</span>
                                                                            ...
                                                                            <div class="control-group">
                                                                                ...
                                                                                <a class="btn btn-white" href="secciones_list.php">Cancel</a>&nbsp;
