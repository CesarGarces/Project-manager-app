...
$single_linea = $objLin->single_linea($id_linea);
...
<head>
    ...
    <title>IZO | Modificar Linea</title>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="lineas_list.php">Lineas</a>
...
<form role="form" action="modify_linea_exe.php" method="post" >

    <input type="hidden"  name="usuario_modifica" value="<?php echo $_SESSION['user']; ?>">

    <?php

    $numrows = mysql_num_rows($single_linea);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($single_linea)){?>

                    <input type="hidden" name="id_linea" value="<?php echo $id_linea;?>">
    ...
    <div class="panel panel-default">
            ...
            <div class="panel-heading"><h3 class="panel-title">Descripcion de la Linea</h3></div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="form-control"  title="Linea" required  name="nombre" value="<?php echo $row["nombre"];?>">

                                <span class="help-block m-b-none">Nombre que describe la Linea</span>
