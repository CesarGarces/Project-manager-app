...
$list_seccion = $objLin->list_seccion();
            ...
            <div class="ibox">
                ...
                <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                ...
                                <a href="new_seccion.php" class="btn btn-primary btn-xs">Nueva Seccion</a>
                ...
                $numrows = mysql_num_rows($list_seccion);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($list_seccion)){
                        ...
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo $row["codigo_seccion"];?>

                                        </td>

                                        <td>

                                            <?php echo $row["seccion_nombre"];?>

                                        </td>                                  

                                        <td>

                                            <?php echo $row["modulo_nombre"];?>

                                        </td>                                     

                                        <td class="project-actions">

                                                <a href="modify_seccion.php?id_seccion=<?php echo $id_seccion;?>" class="btn btn-xs btn-warning glyphicon glyphicon-pencil" title="Editar"></a>

                                                <a href="#" id="<?php echo $id_seccion;?>" class="btn btn-xs btn-danger glyphicon glyphicon-trash btn-sm demo4" title="Eliminar"></a>  
                    ...
                    function (isConfirm) {
                        ...
                        if (isConfirm) {
                            ...
                            setTimeout(function() {
                                 ...
                                 window.location = 'delete_seccion.php?id_seccion='+numero;
