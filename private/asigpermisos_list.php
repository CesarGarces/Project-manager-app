...
<head>
    ...
    <title>IZO | Asignar Permisos</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="asigpermisos_list.php">Asignar Permisos</a></li>
                                                ...
                                                <input type="hidden"  name="usuario_crea" value="<?php echo $_SESSION['user']; ?>">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="panel panel-default">
                                                            ...
                                                            <div class="panel-heading"><h3 class="panel-title">Asignar Permisos</h3>
                                                                                             ...
                                                                                             $numrows = mysql_num_rows($list_modulo);
                                                                                                ...
                                                                                                if($numrows > 0){
                                                                                                    ...
                                                                                                    while($modulo=mysql_fetch_array($list_modulo)){?>
                                                                                                        ...
                                                                                                        <option value="<?php echo $modulo["nombre"];?>"><?php echo $modulo["nombre"];?></option>
                                                                                ...
                                                                                <label label-default="" class="control-label">Rol</label>
                                                                                    ...
                                                                                    <select class="form-control required m-b valid" name="TipoMedicion" required >
                                                                                        ...
                                                                                        <?php
                                                                                             ...
                                                                                             $numrows = mysql_num_rows($list_role);
                                                                                                ...
                                                                                                if($numrows > 0){
                                                                                                    ...
                                                                                                    while($rol=mysql_fetch_array($list_role)){?>
