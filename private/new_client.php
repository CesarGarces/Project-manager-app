...
$list_segmento = $objUse->list_segmento();
               ...
               <span>
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li class="active"><a href="client_list.php">Clientes</a></li>
						...
						<div class="ibox">
							...
							<div class="ibox-content">                    
								...
								<div class="row">
									...
									<form client="form" action="new_client_exe.php" method="post" >
										...
										<input type="hidden"  name="usuario_crea" value="<?php echo $_SESSION['user']; ?>">
											...
											<div class="col-sm-12">
												...
												<div class="panel panel-default">
													...
													<div class="panel-heading"><h3 class="panel-title">Descripcion del cliente</h3>
															...
															<div class="row">
																...
																<div class="col-md-12">
																	...
																	<div class="control-group">
																		...
																		<label label-default="" class="control-label">Nombre Cliente</label>

																			<div class="controls">

																				<input type="text" class="form-control"  title="nombre" required  name="nombre" value="">

																			</div>

																		<label label-default="" class="control-label">Segmento</label>

																			<div class="controls">

																				<select class="form-control required m-b valid" name="id_segmento" required >
																				
																				<?php
																				$numrows = mysql_num_rows($list_segmento);
																					if($numrows > 0){
																						while($row=mysql_fetch_array($list_segmento)){
																							$id_segmento = $row["id_segmento"];?>
																					<option value='<?php echo $row["id_segmento"];?>'><?php echo $row["segmento"];?></option>"; 
																				<?php
																						}
																		...
																		<a class="btn btn-white" href="cliente_list.php">Cancel</a>&nbsp;
