        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                        ...
                        <th>encuestador</th>
						<th>neg_tiempo</th>
                        <th>neg_tiempo_chek1</th>
                        <th>neg_tiempo_chek2</th>
                        <th>neg_tiempo_chek3</th>
						<th>neg_duracion</th>
						<th>neg_duracion_chek1</th>
						<th>neg_duracion_chek2</th>
						<th>neg_gest_com</th>
						<th>neg_gest_com_chek1</th>
						<th>neg_gest_com_chek2</th>
						<th>neg_gest_com_chek3</th>
						<th>neg_trans_pro</th>
						<th>neg_trans_pro_chek1</th>
						<th>meg_deriva</th>
						<th>meg_deriva_chek1</th>
						<th>meg_ocu_canal</th>
						<th>meg_ocu_canal_chek1</th>  
                    </tr>
                    </thead>
                        <tbody>
						...
						<tr>
							...
							<td>
								<?php echo $pec_uf['neg_tiempo'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_tiempo_chek1'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_tiempo_chek2'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_tiempo_chek3'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_duracion'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_duracion_chek1'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_duracion_chek2'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_gest_com'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_gest_com_chek1'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_gest_com_chek2'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_gest_com_chek3'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_trans_pro'] ?>
							</td>
							<td>
								<?php echo $pec_uf['neg_trans_pro_chek1'] ?>
							</td>
							<td>
								<?php echo $pec_uf['meg_deriva'] ?>
							</td>							
							<td>
								<?php echo $pec_uf['meg_deriva_chek1'] ?>
							</td>
							<td>
								<?php echo $pec_uf['meg_ocu_canal'] ?>
							</td>
							<td>
								<?php echo $pec_uf['meg_ocu_canal_chek1'] ?>
							</td>
