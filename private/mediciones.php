...
$objUse = new Users();
$objLin = new Medicion();
$list_medicion = $objLin->list_medicion();
        ...
        <div class="row border-bottom">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-10">
                    ...
                    <h2>Administración de Mediciones</h2>
        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
            ...
            <div class="ibox">
                ...
                <div class="ibox-title">
                            ...
                            <h5>Listado de Mediciones</h5>

                            <div class="ibox-tools">

                                <a href="new_medicion.php" class="btn btn-primary btn-xs">Nueva Medicion</a>
                ...
                $numrows = mysql_num_rows($list_medicion);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($list_medicion)){

                        $id_medicion = $row["id_encuesta"];
                        ...
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions">
                                                ...
                                                <a href="<?php echo $row["link"];?>" class="btn btn-xs btn-info glyphicon glyphicon-eye-open" title="Ver" target="_blank"></a>

                                                <a href="modify_medicion.php?id_medicion=<?php echo $id_medicion;?>" class="btn btn-xs btn-warning glyphicon glyphicon-pencil" title="Editar"></a>

                                                <a href="#" id="<?php echo $id_medicion;?>" class="btn btn-xs btn-danger glyphicon glyphicon-trash btn-sm demo4" title="Eliminar"></a>  
                    ...
                    function (isConfirm) {
                        ...
                        if (isConfirm) {
                            ...
                            setTimeout(function() {
                                 ...
                                 window.location = 'delete_medicion.php?id_medicion='+numero;
