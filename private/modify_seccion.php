...
$single_seccion = $objLin->single_seccion($id_seccion);

$objMod = new Modulo();

$list_modulo = $objMod->list_modulo();
...
<head>
    ...
    <title>IZO | Modificar Seccion</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="secciones_list.php">Secciones</a></li>                      
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="secciones_list.php">Secciones</a>
                        ...
                        <li class="active">
                            ...
                            <strong>Modificar Sección</strong>
...
<form role="form" action="modify_seccion_exe.php" method="post" >

    <input type="hidden"  name="usuario_modifica" value="<?php echo $_SESSION['user']; ?>">

    <?php

    $numrows = mysql_num_rows($single_seccion);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($single_seccion)){?>
    ...
    <div class="panel panel-default">
            ...
            <div class="panel-heading"><h3 class="panel-title">Descripción de la Sección</h3></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="control-group">
                            ...
                            <label label-default="" class="control-label">Cidigo Sección</label>

                            <div class="controls">

                                <input type="text" class="form-control"  required  name="codigo_seccion" value="<?php echo $row["codigo_seccion"];?>">

                                <span class="help-block m-b-none">Cidigo Unico de la Sección</span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="form-control"  title="Linea" required  name="nombre" value="<?php echo $row["nom_seccion"];?>">

                                <span class="help-block m-b-none">Nombre que describe la Sección</span>
                          ...
                          <div class="control-group">
                                                                                ...
                                                                                <label label-default="" class="control-label">Modulo</label>

                                                                                    <div class="controls">

                                                                                    <select class="form-control required m-b valid" name="id_modulo" required >

                                                                                        <option value="<?php echo $row["id_modulo"];?>"><?php echo $row["modulo"];?></option>

                                                                                        <?php

                                                                                             $numrows = mysql_num_rows($list_modulo);
                                                                                                ...
                                                                                                if($numrows > 0){
                                                                                                    ...
                                                                                                    while($modulo=mysql_fetch_array($list_modulo)){?>
                          ...
                          <a class="btn btn-white" href="lineas_list.php">Cancel</a>&nbsp;
