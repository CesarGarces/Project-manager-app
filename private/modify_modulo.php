...
$single_modulo = $objLin->single_modulo($id_modulo);
...
<head>
    ...
    <title>IZO | Modificar Modulo</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="modulos_list.php">Modulos</a></li>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="modulos_list.php">Modulos</a>
                        ...
                        <li class="active">
                            ...
                            <strong>Modificar Modulo</strong>
...
<form role="form" action="modify_modulo_exe.php" method="post" >

    <input type="hidden"  name="usuario_modifica" value="<?php echo $_SESSION['user']; ?>">

    <?php

    $numrows = mysql_num_rows($single_modulo);
                ...
                if($numrows > 0){
                    ...
                    while($row=mysql_fetch_array($single_modulo)){?>
    ...
    <div class="panel panel-default">
            ...
            <div class="panel-heading"><h3 class="panel-title">Descripcion del permiso</h3></div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-block m-b-none">Nombre que describe el modulo.</span>

                            </div>

                          </div>

                          <a class="btn btn-white" href="modulos_list.php">Cancel</a>&nbsp;
