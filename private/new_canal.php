						...
						<div class="ibox">
							...
							<div class="ibox-content">                    
								...
								<div class="row">
									...
									<form canal="form" action="new_canal_exe.php" method="post" >
										...
										<input type="hidden"  name="usuario_crea" value="<?php echo $_SESSION['user']; ?>">
											...
											<div class="col-sm-12">
												...
												<div class="panel panel-default">
													...
													<div class="panel-heading"><h3 class="panel-title">Nuevo Canal</h3>
															...
															<div class="row">
																...
																<div class="col-md-12">
																	...
																	<div class="control-group">
																		...
																		<label label-default="" class="control-label">Nombre Canal</label>

																			<div class="controls">

																				<input type="text" class="form-control"  title="canal" required  name="canal" value="">
